...
To compile spooqs_face_blurring :

In the faceblurringapi directory :
...
- compile executable spooqs_face_blurring :
g++ -I./src -I/usr/local/include/onnxruntime-1.18.1 -I/usr/local/include/opencv4     -L./lib -o exe/spooqs_face_blurring main.cpp     -Wl,-rpath,/var/www/html/dev-canva/faceblurringapi/lib     -lspooqs_face_blurring -lopencv_calib3d -lopencv_core -lopencv_imgproc -lopencv_dnn -lopencv_imgcodecs -lopencv_highgui     -lonnxruntime
